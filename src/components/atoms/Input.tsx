...
export function InputField({
    ...
    return (
        <div className="flex flex-col gap-1">
            <div
                className={cn(
                    'relative ring-1 ring-gray-600 rounded transition-shadow duration-200',
                    errorMessage
                        ? 'ring-red-500'
            ...
            >
                {useTextArea ? (
                    ...
                    <input
                        className="peer mt-6 w-full bg-inherit px-4 pb-1
                       placeholder-transparent outline-none transition"
                        id={inputId}
                ...
                <label
                    className={cn(
                        `group-peer absolute left-4 top-1 bg-main-background text-sm
             text-light-secondary transition-all peer-placeholder-shown:translate-y-3
             peer-placeholder-shown:text-md peer-focus:translate-y-1 peer-focus:text-sm
             dark:text-dark-secondary font-light text-gray-400`,
                        errorMessage
                            ? 'text-red-500'
            ...
            {errorMessage && (
                <p className="text-xs font-light mt-1 text-red-500">
                    {errorMessage}
                </p>
            )}
        </div>
