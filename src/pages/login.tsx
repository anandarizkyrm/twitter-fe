...
import imageBg from '@/assets/twitter-banner.webp'
                ...
                <div className="flex flex-col items-center justify-between gap-6 p-8 lg:items-start lg:justify-center">
                    ...
                    <div className="flex max-w-xs flex-col gap-6 [&_button]:py-2">
                        <div className="grid gap-3 font-bold">
                            <Button
                                className="flex justify-center gap-2 border border-light-line-reply font-bold text-black transition
                         hover:bg-[#e6e6e6] focus-visible:bg-[#e6e6e6] active:bg-[#cccccc] dark:border-0 dark:bg-white
                         dark:hover:brightness-90 dark:focus-visible:brightness-90 dark:active:brightness-75"
                                // onClick={signInWithGoogle}
                            >
                                <CustomIcon iconName="GoogleIcon" /> Sign up
                                with Google
                            </Button>
                            <Button
                                className="flex cursor-not-allowed justify-center gap-2 border border-light-line-reply font-bold text-black
                         ...
                         dark:bg-white dark:hover:brightness-90 dark:focus-visible:brightness-90 dark:active:brightness-75"
                            >
                                <CustomIcon iconName="AppleIcon" /> Sign up with
                                Apple
                            </Button>
